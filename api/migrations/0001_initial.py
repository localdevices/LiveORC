...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Task',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier of task within LiveORC database', primary_key=True, serialize=False, unique=True)),
                ('broker_id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier of task as stored by RabbitMQ messaging service', serialize=False, unique=True)),
                ...
                ('status_msg', models.CharField(help_text='Error messages from back end in case processing failed.', max_length=5000)),
            ],
            options={
                'abstract': False,
            },
