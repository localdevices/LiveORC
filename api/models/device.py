...
class Device(BaseInstituteModel):
    ...
    created_on = models.DateTimeField(help_text="Creation date time", default=datetime.utcnow())
    ...
    last_seen = models.DateTimeField(help_text="Last seen online", default=datetime.utcnow())
